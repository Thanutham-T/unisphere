...
mixin _$ScheduleEntity {
 ...
 int get dayId; String get dayName; String get startTime; String get endTime;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ScheduleEntity&&(identical(other.dayId, dayId) || other.dayId == dayId)&&(identical(other.dayName, dayName) || other.dayName == dayName)&&(identical(other.startTime, startTime) || other.startTime == startTime)&&(identical(other.endTime, endTime) || other.endTime == endTime));
}


@override
int get hashCode => Object.hash(runtimeType,dayId,dayName,startTime,endTime);

@override
String toString() {
  return 'ScheduleEntity(dayId: $dayId, dayName: $dayName, startTime: $startTime, endTime: $endTime)';
}
...
@useResult
$Res call({
 int dayId, String dayName, String startTime, String endTime
});
...
/// Create a copy of ScheduleEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? dayId = null,Object? dayName = null,Object? startTime = null,Object? endTime = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int dayId,  String dayName,  String startTime,  String endTime)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ScheduleEntity() when $default != null:
return $default(_that.dayId,_that.dayName,_that.startTime,_that.endTime);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int dayId,  String dayName,  String startTime,  String endTime)  $default,) {final _that = this;
switch (_that) {
case _ScheduleEntity():
return $default(_that.dayId,_that.dayName,_that.startTime,_that.endTime);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int dayId,  String dayName,  String startTime,  String endTime)?  $default,) {final _that = this;
switch (_that) {
case _ScheduleEntity() when $default != null:
return $default(_that.dayId,_that.dayName,_that.startTime,_that.endTime);case _:
  return null;
...
class _ScheduleEntity implements ScheduleEntity {
  const _ScheduleEntity({required this.dayId, required this.dayName, required this.startTime, required this.endTime});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ScheduleEntity&&(identical(other.dayId, dayId) || other.dayId == dayId)&&(identical(other.dayName, dayName) || other.dayName == dayName)&&(identical(other.startTime, startTime) || other.startTime == startTime)&&(identical(other.endTime, endTime) || other.endTime == endTime));
}
...
/// Create a copy of ScheduleEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? dayId = null,Object? dayName = null,Object? startTime = null,Object? endTime = null,}) {
